...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SIMULATIONUPDATE']._serialized_end=611
  _globals['_SIMULATIONSERVICE']._serialized_start=614
  _globals['_SIMULATIONSERVICE']._serialized_end=863
